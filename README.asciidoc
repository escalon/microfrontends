...
The Svelte compiler removes unused css if you configure it not to cascade styles of a component to child components. That makes it easy for the compiler to decide whether or not a rule is used by a component.
